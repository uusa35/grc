...
export default function SettingEdit({ setting , themes }) {
    ...
    const submit = (e) => {
        e.preventDefault()
        put(route(`backend.setting.update`, setting.id), {
            ...data,
            image: data.image,
            qr: data.qr,
                    ...
                    <div
                        ...
                        <div className="pt-6 grid grid-cols-1 gap-y-2 gap-x-4 sm:grid-cols-6">
                            ...
                            <div className="sm:col-span-3 has-tooltip">
                                ...
                                <p className={`mt-2 text-xs text-${theme}-500`}>
                                    {errors.shipment_notes_ar && <div className={`text-red-600`}>{errors.shipment_notes_ar}</div>}
                                </p>
                            </div>
                            <div className="sm:col-span-3 has-tooltip">
                                <label htmlFor="shipment_notes_en" className={`block text-sm font-medium text-${theme}-700`}>
                                ...
                                <ToolTipWidget message={trans('product_notes_instruction')}/>
                                <p className={`mt-2 text-xs text-${theme}-500`}>
                                    {errors.shipment_notes_en && <div className={`text-red-600`}>{errors.shipment_notes_en}</div>}
                                </p>
                            </div>
                            {/* caption */}
                            <div className="sm:col-span-2 has-tooltip">
                            ...
                            <div className="sm:col-span-3">
                                ...
                                <div className="mt-1 flex flex-row flex-1 items-center">
                                    <input
                                        ...
                                        className={`focus:ring-${theme}-500 focus:border-${theme}-500 block w-full sm:text-sm border-${theme}-300 rounded-md`}
                                    />
                                    <img className={`h-20 w-20 bg-cover rounded-md`} src={getImageThumb(setting.app_logo)}
                                         alt=""/>
                                </div>
                            ...
                            <div className="sm:col-span-3">
                                ...
                                <div className="mt-1 flex flex-row flex-1 items-center">
                                    <input
                                        ...
                                        className={`focus:ring-${theme}-500 focus:border-${theme}-500 block w-full sm:text-sm border-${theme}-300 rounded-md`}
                                    />
                                    <img className={`h-20 w-20 bg-cover rounded-md`} src={getImageThumb(setting.shipment_prices)}
                                         alt=""/>
                                </div>
                                ...
                                <p className={`mt-2 text-xs text-${theme}-500`}>
                                    {errors.shipment_prices && <div className={`text-red-600`}>{errors.shipment_prices}</div>}
                                </p>
                            </div>
                        </div>
