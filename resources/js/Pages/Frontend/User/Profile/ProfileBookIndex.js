...
export default function({elements, firstOrder}) {
    const {classNames, trans, getThumb, getLocalized, getFileUrl, contentBgColor , textColor  } = useContext(AppContext)
                                            ...
                                            <div className="col-span-full">
                                                <table className="min-w-full divide-y divide-gray-200">
                                                    ...
                                                    <tr>
                                                        <th
                                                            scope="col"
                                                            className={classNames(locale.isRTL ? `text-right` : `text-left`, "px-2 py-3  text-xs font-medium text-gray-500 uppercase tracking-wider")}
                                                        >
                                                            {trans('id')}
                                                        </th>
                                                        <th
                                                    ...
                                                    {map(elements.data, element => (
                                                        <tr key={element.name_en}>
                                                            ...
                                                            <td className=" py-4 whitespace-nowrap">{element.sku}</td>
                                                            <td className=" py-4 whitespace-nowrap">
                                                                <div className="flex flex-1 justify-start items-center flex-row">
                                                                    ...
                                                                    <div className="ml-4 px-3">
                                                                        <div
                                                                            className="text-xs font-medium text-gray-900 truncate capitalize">
                                                                            {truncate(element[getLocalized()], { length : 30 })}
                                                                        </div>
                                                                        <div
                                                                            className="text-sm text-gray-500">
                                                                            {getFileType(element.file) === 'pdf' ?
                                                                                <Link
                                                                                    href={route('frontend.profile.book', {
                                                                                    ...
                                                                                    className="truncate"
                                                                                >
                                                                                    {truncate(element[getLocalized('caption')], { length : 15 })}
                                                                                </Link>
                                                                                :
                                                                                <Link href={getFileUrl(element.file)}
                                                                                      className="truncate"
                                                                                >
                                                                                    {truncate(element[getLocalized('caption')], { length : 15 })}
                                                                                </Link>
                                                            ...
                                                            <td className=" py-4 whitespace-nowrap">
                                                                <Link
                                                                    ...
                                                                    <div
                                                                        className="text-xs font-medium text-gray-900 truncate capitalize">
                                                                        {truncate(element.user[getLocalized()], { length : 20 })}
                                                                    </div>
                                                                </Link>
                                                            </td>
                                                ...
                                                { elements.meta.total > 0 &&  <nav
                                                    ...
                                                    <div className="col-span-full sm:col-span-1 flex justify-end mt-5 sm:mt-0">
                                                        {
                                                            !isEmpty(elements.links) && elements.meta.total > 0 && <div className="md:-mt-px md:flex">
                                                                {
                                                                    map(elements.meta.links, page =>
                                                                        <Link
                                                                            key={page.label}
