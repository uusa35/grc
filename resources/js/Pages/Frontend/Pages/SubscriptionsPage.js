            ...
            <FrontendContentContainer>
                ...
                <div className="bg-white relative overflow-hidden">
                    ...
                    >
                        {/* Tiers */}
                        <div
                            className="max-w-2xl mx-auto px-4 space-y-6 sm:px-6 lg:max-w-7xl lg:space-y-0 lg:px-8 lg:grid lg:grid-cols-3 lg:gap-x-8">
                                ...
                                >
                                    <div className="flex-1">
                                        ...
                                        <p className="mt-4 flex justify-between items-baseline text-gray-900">
                                            <span className="text-2xl font-extrabold tracking-tight">{element.price}
                                                <span
                                                    className="text-lg">{currency[getLocalized('currency_symbol')]}</span></span>
                                            {
                                                !currency.country.is_local &&
                                                <span className="text-2xl font-extrabold tracking-tight">
                                                {getConvertedFinalPrice(element.price, currency.exchange_rate)} <span
                                                    className="text-lg">{currency[getLocalized('currency_symbol')]}</span>
                                            </span>
                                            }
                                        </p>
