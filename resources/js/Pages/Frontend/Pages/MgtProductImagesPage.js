        ...
        <FrontendContainer>
            <FrontendContentContainer>
                <main className={`${contentBgColor} max-w-2xl mx-auto py-5 px-4 sm:py-5 sm:px-6 lg:max-w-full lg:px-8`}>
                    <div
                        className="flex flex-1 flex-col justify-start items-start border-b border-gray-200 pb-5">
                        <div className="flex flex-col w-full sm:w-auto mb-5">
                            ...
                            <p className={`mt-4 text-base ${textColor} capitalize`}>
                        ...
                        <div className={`w-full items-center justify-center`}>
                            <ImageGallery
                                ...
                                originalAlt={first(currentProduct[getLocalized()])}
                                originalTitle={first(currentProduct[getLocalized()])}
                                thumbnailLabel={first(currentProduct[getLocalized()])}
                                thumbnailTitle={first(currentProduct[getLocalized()])}
                                showThumbnails={true}
