...
export default function FrontendBookShow({element, relatedElements, auth}) {
    ...
    return (
        <FrontendContainer mainModule={'book'} subModule={element[getLocalized()]}>
            <div className="max-w-2xl mx-auto lg:max-w-none mt-10 pb-10 h-full">
                {/* Product */}
                ...
                {/* related items */}
                {
                    relatedElements && relatedElements.meta.total > 0 && <RelatedItems elements={relatedElements.data} type={'book'}/>
                }
            </div>
        </FrontendContainer>
    )
