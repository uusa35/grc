...
export default function({
    ...
    return (
        <Transition.Root show={confirmationOpen} as={Fragment}>
            ...
            >
                <div
                    className="font-tajwal-medium flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                    <Transition.Child
                        as={Fragment}
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <div className="mt-3 text-center sm:mt-5">
                                    ...
                                    {
                                        message && message.length > 10 && <div className="mt-2">
