...
const pages = [
    {name: 'contactus', url: route('frontend.contactus')},
    {name: 'login', url: route('login')},
    {name: 'register', url: route('register')},
    {name: 'faq', url: route('frontend.faq.index')},
];
                ...
                <div className="xl:grid xl:grid-cols-3 xl:gap-8">
                    <div className="space-y-8 xl:col-span-1">
                        ...
                        <div className="flex gap-x-6">
                            ...
                            {settings.instagram &&
                            <a target="_blank" href={settings.instagram} className="text-gray-400 hover:text-gray-500">
                                <span className="sr-only">{trans('instagram')}</span>
                                <FaInstagram size={25} className={'text-gray-400'}/>
                            </a>
                            }
                            {settings.twitter &&
                            <a target="_blank" href={settings.twitter} className="text-gray-400 hover:text-gray-500">
                                <span className="sr-only">{trans('twitter')}</span>
                                <FaTwitter size={25} className={'text-gray-400'}/>
                            </a>
                            }
                            {settings.whatsapp &&
                            <a target="_blank" href={getWhatsappLink(settings.whatsapp,settings[getLocalized()])} className="text-gray-400 hover:text-gray-500">
                                <span className="sr-only">{trans('whatsapp')}</span>
                                <FaWhatsapp size={25} className={'text-gray-400'}/>
                            </a>
                            }
                        </div>
                    </div>
                        ...
                        <div className="md:grid md:grid-cols-2 md:gap-8">
                            ...
                            <div className="mt-12 md:mt-0">
                                ...
                                <button
                                    ...
                                    <span className="title-font text-sm">Google Play</span>
                                  </span>
                                </button>
                                <button
