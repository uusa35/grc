                ...
                <div className="xl:grid xl:grid-cols-3 xl:gap-8">
                    <div className="space-y-8 xl:col-span-1">
                        ...
                        <div className="flex gap-x-6">
                            {
                                settings.facebook && <a key={settings[getLocalized()]} href={settings.facebook}
                            ...
                            {settings.instagram &&
                            <a href={settings.instagram} className="text-gray-400 hover:text-gray-500">
                            ...
                            {settings.twitter &&
                            <a href={settings.twitter} className="text-gray-400 hover:text-gray-500">
