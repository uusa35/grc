...
export default function Footer() {
    ...
    return (
        <footer className={`border-t-2 border-${footerColor}-400 bg-${footerBgColor}-50 dark:bg-${footerBgColor}-800`} aria-labelledby="footer-heading">
                ...
                <div className="grid sm:grid-cols-2 xl:grid-cols-4 xl:gap-8">
                    <div className=" p-4">
                        <img
                            ...
                            loading={'lazy'}
                        />
                        <p className={`text-${footerColor}-800 dark:text-${footerColor}-200 capitalize text-base mt-5`}>
                        ...
                        <ul className="mt-4 space-y-4">
                            <li>
                                <Link href={route('frontend.contactus')}
                                      className={`text-base text-${footerColor}-800 dark:text-${footerColor}-50 capitalize hover:text-${footerColor}-800 dark:hover:text-${footerColor}-400`}>
                                    {trans('contactus')}
                                </Link>
                            </li>
                            <li>
                        ...
                        <div className="grid grid-cols-5 mt-5">
                            {
                                settings.facebook && <div><a target="_blank" href={settings.facebook}
                                    ...
                                    <FaFacebook size={25} className={`text-${footerColor}-800 dark:text-${footerColor}-50 hover:text-${footerColor}-800 dark:hover:text-${footerColor}-400`}/>
                                </a></div>
                            }
                            {settings.instagram &&
                            <a target="_blank" href={settings.instagram}
                               className={`col-span-1 text-${footerColor}-800 dark:text-${footerColor}-50 hover:text-${footerColor}-800 dark:hover:text-${footerColor}-400 capitalize`}>
                                ...
                                <FaInstagram size={25} className={`text-${footerColor}-800 dark:text-${footerColor}-50 hover:text-${footerColor}-800 dark:hover:text-${footerColor}-400`}/>
                            </a>
                            }
                            {settings.twitter &&
                            <a target="_blank" href={settings.twitter}
                               className={`col-span-1 text-${footerColor}-800 dark:text-${footerColor}-50 hover:text-${footerColor}-800 dark:hover:text-${footerColor}-400 capitalize`}>
                                ...
                                <FaTwitter size={25} className={`text-${footerColor}-800 dark:text-${footerColor}-50 hover:text-${footerColor}-800 dark:hover:text-${footerColor}-400`}/>
                            </a>
                            }
                            {settings.youtube &&
                            <a target="_blank" href={settings.youtube}
                               className={`col-span-1 text-${footerColor}-800 dark:text-${footerColor}-50 hover:text-${footerColor}-800 dark:hover:text-${footerColor}-400 capitalize`}>
                                ...
                                <FaYoutube size={25} className={`text-${footerColor}-800 dark:text-${footerColor}-50 hover:text-${footerColor}-800 dark:hover:text-${footerColor}-400`}/>
                            </a>
                            }
                            {settings.whatsapp &&
                            <a target="_blank"
                               ...
                               className={`col-span-1 text-${footerColor}-800 dark:text-${footerColor}-50 hover:text-${footerColor}-800 dark:hover:text-${footerColor}-400 capitalize`}>
                                ...
                                <FaWhatsapp size={25} className={`text-${footerColor}-800 dark:text-${footerColor}-50 hover:text-${footerColor}-800 dark:hover:text-${footerColor}-400`}/>
                            </a>
                            }
                        </div>
                    </div>
