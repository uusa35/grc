    ...
    return (
        <div
            ...
            <div className="flex overflow-hidden">
                ...
                >
                    <h1 className={`hidden sm:block text-${mainColor}-900 dark:text-${mainColor}-100`}>{trans('back')}</h1>
                    {locale.isRTL ?
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" color={mainColor} fill="none" viewBox="0 0 24 24"
                             stroke="currentColor">
