...
export default function({children, showBreadCrumbs = true, childName = '', parentModuleName = null}) {
    ...
    return (
        <div className={classNames(settings.wide_screen && currentHome ? `` : `xl:w-4/5 2xl:w-3/5 m-auto`, ` ${textColor} ${mainBgColor} w-full md:w-full lg:w-full  shadow-xl min-h-screen pb-10 text-sm`)}>
