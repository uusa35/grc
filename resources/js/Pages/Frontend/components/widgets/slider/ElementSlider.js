            ...
            {!isEmpty(elements) && route().has(`frontend.${type}.index`) && (
                <>
                    ...
                    >
                        ...
                        >
                            <span className={`text-${mainColor}-800 dark:text-${mainColor}-200`}>{pluralize(title)}</span>
                        </motion.div>
                        {
                            isRTL ? <div className={`flex flex-row items-center`}>
                                <span className={`text-${mainColor}-800 dark:text-${mainColor}-200 text-xs`}>{trans('show_all')}</span>
