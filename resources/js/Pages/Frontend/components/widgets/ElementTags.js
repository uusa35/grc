    ...
    return (
        <div className="relative opacity-80">
            <div
                ...
                {
                    onSale && <span
                        className="inline-flex justify-center items-center shadow-md px-6 py-0.5 rounded-md  bg-red-900 ">
                        {trans('on_sale')}
                      </span>
                }
                {
                    onNew && <span
                        className="inline-flex justify-center items-center shadow-md px-6 py-0.5 rounded-md bg-gray-800 ">
                    {trans('on_new')}
                        </span>
                }
                {
                    exclusive && <span
                        className="inline-flex justify-center items-center shadow-md px-6 py-0.5 rounded-md bg-gray-600 ">
                    {trans('exclusive')}
                        </span>
                }
            </div>
