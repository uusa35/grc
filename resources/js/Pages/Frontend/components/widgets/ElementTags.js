...
export default function ElementTags({onNew = false , onSale = false , exclusive = false, free = false, showFavoriteIcon  = true}) {
    ...
    return (
        <div className="relative opacity-40 z-40">
            <div
            ...
            </div>
            {
                showFavoriteIcon ? <div
                    className={classNames(locale.isRTL ? `left-2` : `right-2`, 'absolute top-8 flex flex-col  gap-y-3 text-white text-sm bg-white rounded-full w-10 h-10 justify-center items-center opacity-40')}>
