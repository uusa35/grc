    ...
    return (
        <div className="relative opacity-60 z-40">
            <div
                ...
                {
                    onSale && !free ? <span
                        className={classNames(rounded ? `rounded-tl-lg rounded-br-lg` : `` , `inline-flex justify-center items-center capitalize shadow-md px-4 py-0.5 rounded-sm  bg-red-900 mb-3 `)}>
                        {trans('on_sale')}
                      </span> : null
                }
                {
                ...
                {
                    free ? <span
                        className={classNames(rounded ? `rounded-tl-lg rounded-br-lg` : `` , `inline-flex justify-center items-center capitalize shadow-md px-4 py-0.5 rounded-sm bg-hippie-blue-400 mb-3`)}>
                    {trans('free')}
                        </span> : null
                }
            </div>
