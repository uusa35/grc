                                ...
                                <Menu as="div" className="relative inline-block text-left mb-5 w-full">
                                    <div>
                                        <Menu.Button
                                            ...
                                            <div>
                                                {!isEmpty(selectedTiming) ? moment(`${selectedTiming.date} ${selectedTiming.start}`).format('dddd : L - HH:mm A') : (element.timings.length > 0 ? trans('available_timings') : trans('no_timings'))}
                                            </div>
