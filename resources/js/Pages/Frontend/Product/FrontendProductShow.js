                        ...
                        <form className="mt-10">
                            ...
                            <div>
                                ...
                                <RadioGroup value={selectedColor} onChange={setSelectedColor} className="mt-4">
                                    ...
                                    <div className="flex items-center space-x-3">
                                        {element.product_attributes.map((color) => (
                                            <RadioGroup.Option
                                                key={color[getLocalized()]}
                                                value={color}
                            ...
                            <div className="mt-10">
                                <div className="flex items-center justify-between">
                                    <h3 className="text-sm text-gray-900 font-medium">{trans('sizes')}</h3>
                                ...
                                <RadioGroup value={selectedSize} onChange={setSelectedSize} className="mt-4">
                                    ...
                                    <div className="grid grid-cols-4 gap-4 sm:grid-cols-8 lg:grid-cols-4">
                                        {element.product_attributes.map((size) => (
                                            <RadioGroup.Option
                                                key={size[getLocalized()]}
                                                value={size}
                                            ...
                                            >
                                                {({ active, checked }) => (
                                                    <>
                                                        <RadioGroup.Label as="p">{size[getLocalized()]}</RadioGroup.Label>
                                                        {size.inStock ? (
                                                            <div
                                                                className={classNames(
