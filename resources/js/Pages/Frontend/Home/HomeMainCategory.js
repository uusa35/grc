                    ...
                    <div
                        ...
                        <div>
                            <h2 className="text-xl font-bold text-white truncate capitalize">{element[getLocalized()]}</h2>
                            {
                                ...
                                <p className="mt-1 text-sm text-white font-bold truncate capitalize">
                        ...
                        <Link
                            ...
                            className="mt-6 flex-shrink-0 flex bg-white bg-opacity-0 py-3 px-4 border border-white border-opacity-25 rounded-md items-center justify-center text-base font-medium text-white hover:bg-opacity-10 sm:mt-0 sm:ml-8 lg:ml-0 lg:w-full capitalize"
                        >
                            {trans('view')}
                        </Link>
                    </div>
