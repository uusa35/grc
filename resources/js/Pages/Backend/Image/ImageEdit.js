...
export default function({image}) {
    ...
    const submit = (e) => {
        e.preventDefault()
        Inertia.post(route(`backend.image.update`, image.id), {
            _method: 'put',
            ...data,
            image: data.image,
        }, {
                ...
                >
                    <FormSection title={`${trans('edit')} ${trans('image')}`}>
                        ...
                        <div className="sm:col-span-2">
                            ...
                            <ToolTipWidget message={trans('caption_ar _instruction')}/>
                            <p className={`mt-2  text-gray-500`}>
                        ...
                        <div className="sm:col-span-3 has-tooltip mt-5">
                            ...
                            <div className="mt-1 flex flex-row flex-1 items-center h-32">
                                ...
                                />
                                <img className={`h-24 w-20 bg-cover rounded-md`} src={getThumb(image.image)} alt=""/>
                            </div>
