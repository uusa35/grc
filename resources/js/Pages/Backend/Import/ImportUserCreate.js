        ...
        <BackendContainer mainModule={model}>
            <FormTabsContainer>
                <form
                    ...
                    {/* main section*/}
                    <FormSection title={`${trans('create')} ${trans(parentModule)} ${trans(model)}`}
                                 message={trans('all_information_required')}
                    >
                        <div className="col-span-full">
                            {
                                isAdminOrAbove && model && <AlertMessage title={trans('important')}
                            ...
                            {
                                isAdminOrAbove &&
                                <div className={`col-span-full py-3 flex justify-center items-center`}><a
                                    className={`p-4 border border-gray-100 bg-gray-600 text-white rounded-md shadow-md`}
                                    href={route(`backend.${model}.export`, {fileType: 'xlsx'})}>
                        ...
                        <div className="sm:col-span-2">
                            {
                                isAdminOrAbove && <>
                                    <label htmlFor="role_id" className="block  font-medium text-gray-800">
                                        {trans('role')}
                                    </label>
                                    <div className="mt-1">
                                        <select
                        ...
                        <div className="sm:col-span-2">
                            {
                                isAdminOrAbove && <>
                                    <label htmlFor="country_id" className="block  font-medium text-gray-800">
                                        {trans('country')}
                                    </label>
                                    <div className="mt-1">
                                        <select
