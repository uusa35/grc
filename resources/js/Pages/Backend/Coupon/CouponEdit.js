...
export default function({coupon}) {
    ...
    const submit = (e) => {
        e.preventDefault()
        Inertia.post(route(`backend.coupon.update`, coupon.id), {
            _method: 'put',
            ...data,
            image: data.image,
        }, {
                ...
                >
                    <FormSection title={`${trans('edit')} ${trans('coupon')}`}>
                        ...
                        <div className="sm:col-span-2">
                            ...
                            <ToolTipWidget message={trans('value_instruction')}/>
                        ...
                        <div className="sm:col-span-2 has-tooltip mb-5">
                            ...
                            <ToolTipWidget message={trans('coupon_end_sale_instruction')}/>
                            <p className={`mt-2  text-gray-500`}>
                                    <span
                                        className={`text-extrabold  text-black`}>{trans('current_date')} : {moment(coupon.due_date).format('DD/MM/Y')}</span>
                                {errors.due_date && <div className={`text-red-900`}>{errors.due_date}</div>}
                            </p>
                        </div>
                    ...
                    <FormSection title={trans('more_details')}>
                        ...
                        <fieldset className="mt-1 col-span-1">
                            <div>
                                <legend
                                    className={`text-base  text-gray-900`}>{trans('is_percentage')}</legend>
                            </div>
                            <div className="mt-4 space-y-4">
                                <div className="flex items-center">
                                    <input
                            ...
                            <div>
                                <p className={`mt-2  text-gray-500`}>
                                    {errors.is_percentage && <div className={`text-red-900`}>{errors.is_percentage}</div>}
                                </p>
                            </div>
                        </fieldset>
                        ...
                        <fieldset className="mt-1 col-span-1">
                            <div>
                                <legend
                                    className={`text-base  text-gray-900`}>{trans('is_permanent')}</legend>
                            </div>
                            <div className="mt-4 space-y-4">
                                <div className="flex items-center">
                                    <input
                            ...
                            <div>
                                <p className={`mt-2  text-gray-500`}>
                                    {errors.is_permanent && <div className={`text-red-900`}>{errors.is_permanent}</div>}
                                </p>
                            </div>
                        </fieldset>
                        ...
                        <fieldset className="mt-1 col-span-1">
                            <div>
                                <legend
                                    className={`text-base  text-gray-900`}>{trans('consumed')}</legend>
                            </div>
                            <div className="mt-4 space-y-4">
                                <div className="flex items-center">
                                    <input
                            ...
                            <div>
                                <p className={`mt-2  text-gray-500`}>
                                    {errors.consumed && <div className={`text-red-900`}>{errors.consumed}</div>}
                                </p>
                            </div>
                        </fieldset>
                    </FormSection>
