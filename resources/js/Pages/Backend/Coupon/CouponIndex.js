                                        ...
                                        <div className="flex flex-row justify-between items-center">
                                            ...
                                            <div className="flex">
                                                <Link
                                                    ...
                                                    href={route('backend.coupon.create', {user_id: elements.data.length > 0 ? elements.data[0]?.user_id : params.user_id})}>
                                    ...
                                    <tr key={element.id} className={`odd:bg-white even:bg-gray-100`}>
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap text-sm ">
                                            <div className="flex flex-row items-center justify-around">
                                                ...
                                                <button
                                                    onClick={() => handleDeleteItem('destroy', 'coupon', element.id)}
