...
export default function({role, privileges, auth}) {
    ...
    const submit = (e) => {
        e.preventDefault()
        Inertia.post(route(`backend.role.update`, role.id), {
            _method: 'put',
            ...data,
            image: data.image,
            onSuccess: () => {
            ...
            <div className="flex flex-col bg-white shadow-md rounded-md">
                <form
                    ...
                    <div className="space-y-4 divide-y 900">
                        {/* title */}
                        <div className={`pt-4`}>
                            <h3 className="text-lg leading-6 font-medium text-gray-900">{trans('edit')} {trans('role')}</h3>
                                                    ...
                                                    <div
                                                        ...
                                                        <div className="relative flex items-start">
                                                            <div
                                                                ...
                                                                <input
                                                                    onChange={e => handleSelectedElements(e.target.checked, e.target.value)}
                                                                    id="privileges"
                                                                    aria-describedby="privileges-description"
                                                                    name="privileges"
                                                                    value={c.id}
                                                                    defaultChecked={first(filter(role.privileges, s => s.id == c.id))}
                                                                    type="checkbox"
...
accept="image/jpg, image/jpeg , image/png"
                        ...
                        <div className="pt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-4">
                            ...
                            <fieldset className="mt-1 col-span-1">
                                <div>
                                    <legend
                                        className={`text-xs text-base text-gray-900`}>{trans('is_super')}</legend>
                                </div>
                                <div className="mt-4 space-y-4">
                                    <div className="flex items-center">
                                        <input
                            ...
                            <fieldset className="mt-1 col-span-1">
                                <div>
                                    <legend
                                        className={`text-xs text-base text-gray-900`}>{trans('is_admin')}</legend>
                                </div>
                                <div className="mt-4 space-y-4">
                                    <div className="flex items-center">
                                        <input
                            ...
                            <fieldset className="mt-1 col-span-1">
                                <div>
                                    <legend
                                        className={`text-xs text-base text-gray-900`}>{trans('is_company')}</legend>
                                </div>
                                <div className="mt-4 space-y-4">
                                    <div className="flex items-center">
                                        <input
                            ...
                            <fieldset className="mt-1 col-span-1">
                                <div>
                                    <legend
                                        className={`text-xs text-base text-gray-900`}>{trans('is_author')}</legend>
                                </div>
                                <div className="mt-4 space-y-4">
                                    <div className="flex items-center">
                                        <input
                            ...
                            <fieldset className="mt-1 col-span-1">
                                <div>
                                    <legend
                                        className={`text-xs text-base text-gray-900`}>{trans('is_designer')}</legend>
                                </div>
                                <div className="mt-4 space-y-4">
                                    <div className="flex items-center">
                                        <input
                            ...
                            <fieldset className="mt-1 col-span-1">
                                <div>
                                    <legend
                                        className={`text-xs text-base text-gray-900`}>{trans('is_celebrity')}</legend>
                                </div>
                                <div className="mt-4 space-y-4">
                                    <div className="flex items-center">
                                        <input
                            ...
                            <fieldset className="mt-1 col-span-1">
                                <div>
                                    <legend
                                        className={`text-xs text-base text-gray-900`}>{trans('is_visible')}</legend>
                                </div>
                                <div className="mt-4 space-y-4">
                                    <div className="flex items-center">
                                        <input
                            ...
                            <fieldset className="mt-1 col-span-1">
                                <div>
                                    <legend
                                        className={`text-xs text-base text-gray-900`}>{trans('is_driver')}</legend>
                                </div>
                                <div className="mt-4 space-y-4">
                                    <div className="flex items-center">
                                        <input
