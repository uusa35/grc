                ...
                <form
                    ...
                    <div className="space-y-4 divide-y 900">
                        <div className={`sm:col-span-full pt-4`}>
                            <h3 className="text-lg leading-6 font-medium text-gray-900">{trans('create')} {trans('slide')}</h3>
...
accept="image/jpg, image/jpeg , image/png"
                            ...
                            {/* CAPTION AR */}
                            <div className="sm:col-span-3 has-tooltip">
                                <label htmlFor="caption_ar" className={`block  font-medium text-gray-700`}>
                                    {trans('caption_ar')}
                                </label>
                                <div className="mt-1">
                                    <input
                            ...
                            {/* CAPTION en */}
                            <div className="sm:col-span-3 has-tooltip">
                                <label htmlFor="caption_en" className={`block  font-medium text-gray-700`}>
                                    {trans('caption_en')}
                                </label>
                                <div className="mt-1">
                                    <input
                        ...
                        {/* DEEP LINKING */}
                        {
                            isAdminOrAbove ?
                                <div className="py-6 grid grid-cols-1 gap-y-2 gap-x-4 sm:grid-cols-6">
                                    ...
                                    {/*USER ID*/}
                                    <div
                                        className={classNames(data.type === 'user' ? 'visible' : 'hidden', 'sm:col-span-2')}>
                                        <label htmlFor="user_id" className="block  font-medium text-gray-700">
                                            {trans(data.type)}
                                        </label>
                                        <div className="mt-1">
                                    ...
                                    <div
                                        ...
                                        <label htmlFor="product_id" className="block  font-medium text-gray-700">
                                            {trans(data.type)}
                                        </label>
                                        <div className="mt-1">
                                            <select
                                    ...
                                    <div
                                        ...
                                        <label htmlFor="book_id" className="block  font-medium text-gray-700">
                                            {trans(data.type)}
                                        </label>
                                        <div className="mt-1">
                                            <select
                                    ...
                                    <div
                                        ...
                                        <label htmlFor="course_id" className="block  font-medium text-gray-700">
                                            {trans(data.type)}
                                        </label>
                                        <div className="mt-1">
                                            <select
                                    ...
                                    <div
                                        ...
                                        <label htmlFor="service_id" className="block  font-medium text-gray-700">
                                            {trans(data.type)}
                                        </label>
                                        <div className="mt-1">
                                            <select
                            ...
                            <div className="flex flex-1 flex-col justify-start items-center w-full">
                                <div
                                    ...
                                    <fieldset className="mt-1 has-tooltip col-span-1">
                                        <div>
                                            <legend
                                                className={`text-base font-medium text-gray-900`}>{trans('is_video')}</legend>
                                        </div>
                                        <div className="mt-4 space-y-4">
                                            <div className="flex items-center">
                                                <input
                                    ...
                                    <fieldset className="mt-1 has-tooltip col-span-1">
                                        <div>
                                            <legend
                                                className={`text-base font-medium text-gray-900`}>{trans('is_intro')}</legend>
                                        </div>
                                        <div className="mt-4 space-y-4">
                                            <div className="flex items-center">
                                                <input
                                        ...
                                        <ToolTipWidget message={trans('book_is_intro_instruction')}/>
                                        <div>
                                            <p className={`mt-2  text-gray-500`}>
                                                {errors.is_intro &&
