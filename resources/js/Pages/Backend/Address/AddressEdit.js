...
export default function({ countries , address }) {
    ...
    const submit = (e) => {
        e.preventDefault()
        Inertia.post(route(`backend.address.update`, address.id), {
            _method: 'put',
            ...data,
        }, {
            forceFormData: true,
                ...
                >
                    <FormSection title={`${trans('edit')} ${trans('address')}`}>
                        ...
                        <div className="sm:col-span-1">
                            <label htmlFor="block" className={`block   text-gray-800`}>
                                {trans('block')}
                            </label>
                            <div className="mt-1">
                                <input
                            ...
                            <ToolTipWidget message={trans('block_instruction')}/>
                            <p className={`mt-2  text-gray-500`}>
                        ...
                        {/* street */}
                        <div className="sm:col-span-2">
                            <label htmlFor="street" className={`street   text-gray-800`}>
                                {trans('street')}
                            </label>
                            <div className="mt-1">
                                <input
                            ...
                            <ToolTipWidget message={trans('street_instruction')}/>
                            <p className={`mt-2  text-gray-500`}>
                        ...
                        {/* building */}
                        <div className="sm:col-span-1">
                            <label htmlFor="building" className={`building   text-gray-800`}>
                                {trans('building')}
                            </label>
                            <div className="mt-1">
                                <input
                            ...
                            <ToolTipWidget message={trans('building_instruction')}/>
                            <p className={`mt-2  text-gray-500`}>
                        ...
                        {/* floor */}
                        <div className="sm:col-span-1">
                            <label htmlFor="floor" className={`floor   text-gray-800`}>
                                {trans('floor')}
                            </label>
                            <div className="mt-1">
                                <input
                            ...
                            <ToolTipWidget message={trans('floor_instruction')}/>
                            <p className={`mt-2  text-gray-500`}>
                        ...
                        {/* apartment */}
                        <div className="sm:col-span-1">
                            <label htmlFor="apartment" className={`apartment   text-gray-800`}>
                                {trans('apartment')}
                            </label>
                            <div className="mt-1">
                                <input
                            ...
                            <ToolTipWidget message={trans('apartment_instruction')}/>
                            <p className={`mt-2  text-gray-500`}>
                        ...
                        <div className="sm:col-span-3 has-tooltip">
                            ...
                            <p className={`mt-2  text-gray-500`}>
                                {errors.content &&
                                <div className={`text-red-900`}>{errors.content}</div>}
                            </p>
                        </div>
