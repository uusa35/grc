...
export default function({translation }) {
    ...
    const submit = (e) => {
        e.preventDefault()
        Inertia.post(route(`backend.translation.update`, translation.id), {
            _method: 'put',
            ...data,
        }, {
            forceFormData: true,
    ...
    return (
        <BackendContainer type={'translation'}>
            <div className="flex flex-col rounded-md bg-transparent">
                ...
                >
                    <FormSection title={`${trans('edit')} ${trans('translation')}`}>
                        {/* ar */}
                        <div className="sm:col-span-2">
                            <label htmlFor="ar" className={`block   text-gray-800`}>
                                {trans('ar')}
                            </label>
                            <div className="mt-1">
                                <textarea
                            ...
                            <p className={`mt-2  text-gray-500`}>
                                {errors.ar && <div className={`text-red-900`}>{errors.ar}</div>}
                            </p>
                        </div>
                        {/* en */}
                        <div className="sm:col-span-2">
                            <label htmlFor="en" className={`block   text-gray-800`}>
                                {trans('en')}
                            </label>
                            <div className="mt-1">
                                <textarea
                            ...
                            <p className={`mt-2  text-gray-500`}>
                                {errors.en && <div className={`text-red-900`}>{errors.en}</div>}
                            </p>
                        </div>

                        {/* key */}
                        <div className="sm:col-span-2">
                            <label htmlFor="key" className={`block   text-gray-800`}>
                                {trans('key')}
                            </label>
                            <div className="mt-1">
                                <input
                            ...
                            <p className={`mt-2  text-gray-500`}>
                                {errors.key && <div className={`text-red-900`}>{errors.key}</div>}
                            </p>
                        </div>
