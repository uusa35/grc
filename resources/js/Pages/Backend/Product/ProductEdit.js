                    ...
                    <div
                        ...
                        <div className="pt-6 grid grid-cols-1 gap-y-2 gap-x-4 sm:grid-cols-6">
                            ...
                            <div className="sm:col-span-2 has-tooltip mb-5">
                                ...
                                <p className={`mt-2  text-${theme}-500`}>
                                    <span className={`text-extrabold  text-black`}>{trans('current_date')} : {moment(product.start_sale).format('DD/MM/Y  -|- hh:mm a')}</span>
                            ...
                            <div className="sm:col-span-2 has-tooltip mb-5">
                                ...
                                <p className={`mt-2  text-${theme}-500`}>
                                    <span className={`text-extrabold  text-black`}>{trans('current_date')} : {moment(product.end_sale).format('DD/MM/Y  -|- hh:mm a')}</span>
