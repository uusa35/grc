                                            ...
                                            <td className="px-3 py-4 whitespace-nowrap text-gray-500">
                                                ...
                                                <div
                                                    className="flex flex-1 flex-row justify-between space-x-3 mt-2 items-center">
                                                        <span
                                                            className={`inline-flex items-center px-2 py-0.5 rounded  font-medium bg-${element.has_attributes && !isEmpty(element.product_attributes) ? 'green' : 'red'}-100 text-${theme}-800`}>
