...
export default function({subscription}) {
    ...
    const submit = (e) => {
        e.preventDefault()
        Inertia.post(route(`backend.subscription.update`, subscription.id), {
            _method: 'put',
            ...data,
            image: data.image,
        }, {
            ...
            <div className="flex flex-col bg-white shadow-md rounded-md">
                <form
                    ...
                    <div className="space-y-4 divide-y 900">
                        <div className={`pt-4`}>
                            <h3 className="text-lg leading-6 font-medium text-gray-900">{trans('edit')} {trans('subscription')}</h3>
                        ...
                        <div className="pt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                            ...
                            <div className="sm:col-span-3 has-tooltip mt-5">
                                ...
                                <div className="mt-1 flex flex-row flex-1 items-center h-32">
                                    ...
                                    />
                                    <img className={`h-24 w-20 bg-cover rounded-md`} src={getThumb(subscription.image)} alt=""/>
                                </div>
                            ...
                            <div className="sm:col-span-full has-tooltip">
                                ...
                                <div className="mt-1">
                                    <ReactQuill theme="snow"
                                                ...
                                                onChange={(e) => setData('description_en', e)}
                                                className="h-40"
                                    />
                                </div>
                            ...
                            <div className="sm:col-span-full has-tooltip">
                                ...
                                <div className="mt-1">
                                    <ReactQuill theme="snow"
                                                ...
                                                onChange={(e) => setData('description_ar', e)}
                                                className="h-40"
                                    />
                                </div>
                                <ToolTipWidget message={trans('product_aboutus_instruction')}/>
                                ...
                                <div className="mt-4 space-y-4">
                                    <div className="flex items-center">
                                        <input
                                            ...
                                            type="radio"
                                            value={1}
                                            defaultChecked={subscription.on_sale}
                                            className={`mx-5 focus:ring-gray-500 h-4 w-4 text-gray-600 border-gray-300`}
                                        />
                                ...
                                <div className="mt-4 space-y-4">
                                    <div className="flex items-center">
                                        <input
                                            ...
                                            type="radio"
                                            value={1}
                                            defaultChecked={subscription.is_featured}
                                            className={`mx-5 focus:ring-gray-500 h-4 w-4 text-gray-600 border-gray-300`}
                                        />
