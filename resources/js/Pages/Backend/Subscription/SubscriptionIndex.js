                                ...
                                <tr>
                                    ...
                                    >
                                        <div className="flex flex-row justify-between items-center">
                                            ...
                                            <div className="flex">
                                                <Link
                                                    href={route('backend.subscription.create', {user_id: elements.data.length > 0 ? elements.data[0]?.user_id : params.user_id})}>
                                    ...
                                    <tr key={element.id}>
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap text-sm ">
                                            <div className="flex flex-row items-center justify-around">
                                                <Link href={route(`backend.subscription.edit`, element.id)}
                                                ...
                                                <button
                                                    onClick={() => handleDeleteItem('destroy', 'subscription', element.id)}
