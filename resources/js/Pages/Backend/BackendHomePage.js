                                    ...
                                    <div className="bg-white p-6">
                                        <div className="sm:flex sm:items-center sm:justify-between">
                                            <div className="sm:flex sm:space-x-5">
                                                ...
                                                <div
                                                    className="mt-4 text-center sm:mt-0 sm:pt-1 rtl:text-right ltr:text-left">
                            ...
                            {!isEmpty(modules) && map(filter(modules, m => m.index && m.on_top && !m.hide_module && route().has(`backend.${m.name}.index`)), (m) => (
                                <li key={m.name} className={`flow-root rounded-md px-2  bg-white`}>
                                    <div
                                        ...
                                        >
                                            <img className={`rtl:ml-3 ltr:mr-3 rounded-md w-14 h-auto`}
                                                 src={getThumb(m.image)} alt={m.name}/>
                                        </div>
                                        <div>
                                            <h3 className={`text-sm font-medium text-gray-900`}>
                                                <Link
                                                    href={m.main_menu ? `/backend/${m.name}/search` : `/backend/${m.name}`}
