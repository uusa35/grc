        ...
        <div className="flex flex-1 flex-col justify-start min-h-screen items-center bg-transparent">
            <div className="flex flex-row w-full justify-between items-center bg-white border-b-2 border-gray-200">
                ...
                </div>
                {
                    !isAdminOrAbove && <div>
                        <Link href={'#'}
                              className={classNames(locale.isRTL ? `rounded-r-lg` : `rounded-l-lg`, 'h-10 flex flex-row justify-between items-center rtl:mr-5 ltr:ml-5 w-20 bg-hippie-blue-300 hover:text-white hover:bg-hippie-blue-600 shadow-md')}
