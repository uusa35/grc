...
export default function ConfirmationModal() {
    ...
    return (
        <Transition.Root show={confirmationModal.display} as={Fragment}>
            ...
            >
                <div className={classNames(locale.isRTL ? 'font-tajwal-medium' : 'font-tajwal-medium', "flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0 capitalize")}>
                    <Transition.Child
                        as={Fragment}
                    ...
                    >
                        <div
                            ...
                            <div className="mt-5 sm:mt-6 sm:grid sm:grid-cols-2 sm:gap-3 sm:grid-flow-row-dense">
                                ...
                                <button
                                    type="button"
                                    className={classNames(confirmationModal.type === 'destroy' ? 'bg-red-900' : `bg-gray-600`, `w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 text-base font-medium text-white hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 sm:col-start-2 sm:text-sm capitalize`)}
