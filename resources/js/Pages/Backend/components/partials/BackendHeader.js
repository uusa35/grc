                                ...
                                >
                                    ...
                                    >
                                        ...
                                        {isAdminOrAbove && <>
                                            ...
                                            <div className="py-1 capitalize">
                                                <Menu.Item>
                                                    {({active}) => (
                                                        ...
                                                        >
                                                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mx-4" viewBox="0 0 20 20" fill="currentColor">
                                            ...
                                            {
                                                settings.enable_cart && <div className="py-1 capitalize">
                                                    <Menu.Item>
                                                        {({active}) => (
                                                            <Link
                                                                href={route(`backend.trashed.index`, { type : 'order'})}
                                                                className={classNames(
                                                                    active ? 'bg-gray-100 text-gray-900' : 'text-gray-800',
                                                                    'group flex items-center px-4 py-2 '
                                                                )}
