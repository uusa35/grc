...
export default function() {
    ...
    return (
        <Head>
            <title>{`${capitalize(trans(pluralize(parentModule)))} :: ${capitalize(settings[getLocalized()])}`}</title>
            <meta head-key="description" name="description"
                  content={ settings[getLocalized('description')]}/>
            <meta head-key="title" name="title" content={ capitalize(settings[getLocalized()])}/>
            <meta head-key="description" name="description"
                  content={ settings[getLocalized('description')]}/>
            ...
            <link href={getThumb(settings.image)} rel="shortcut icon" type="image/png"/>
            <meta name={ capitalize(settings[getLocalized()])} content="E-commerce"/>
            <meta
                key="theme-color"
                name="theme-color"
                content={settings.main_theme_color}
            />
            <meta key="keywords" name="keywords" content={capitalize(settings[getLocalized()])}/>
            <meta key="author" name="author" content={capitalize(settings[getLocalized()])}/>
            <meta key="country" name="country" content={capitalize(settings.country)}/>
            ...
            <meta key="name" name="name" content={capitalize(settings[getLocalized()])}/>
            ...
            <meta
                ...
                content={`${ settings[getLocalized('description')]}`}
            />
            <meta itemProp="name" content={capitalize(settings[getLocalized()])}/>
            ...
            <meta
                ...
                key="ogtitle"
            />
            <meta property="og:description" content={ capitalize(settings[getLocalized()])} key="ogdesc"/>
