                            ...
                            {({open}) => (
                                <>
                                    ...
                                    >
                                        <Menu.Items
                                            static
                                            className={classNames(locale === 'ar' ? 'right-50' : 'right-50', " z-50 mx-10 origin-top-right absolute top-3 w-48 mt-1 bg-white rounded-md shadow-lg ring-1 ring-black ring-opacity-5 divide-y divide-gray-200 focus:outline-none")}
                                        >
                                            <div className="py-1">
                                                <Menu.Item>
                                                    {({active}) => (
