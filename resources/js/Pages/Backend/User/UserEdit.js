...
export default function({user, roles, elementCategories, categories, countries, subscriptions}) {
    ...
    const submit = (e) => {
        e.preventDefault()
        Inertia.post(route(`backend.user.update`, user.id), {
            _method: 'put',
            ...data,
            image: data.image,
            qr: data.qr,
                    ...
                    <div
                        ...
                        <FormSection title={`${trans('edit')} ${trans(parentModule)}`}>
                            ...
                            <div className="sm:col-span-2">
                                ...
                                <ToolTipWidget message={trans('user_price_instruction')}/>
                                    ...
                                    >
                                        {
                                            map(subscriptions, u => (
                                                <option key={u.id} value={u.id}
                                                        selected={u.id === user.subscription_id}
                            ...
                            <div className="sm:col-span-2">
                                {isAdminOrAbove && <>
                                    ...
                                    <ToolTipWidget message={trans('user_instruction')}/>
                                    <p className={`mt-2  text-gray-500`}>
                                        {errors.role_id && <div className={`text-red-900`}>{errors.role_id}</div>}
                                    </p>
                                </>}
                            </div>
                            {/* country_id */}
                        ...
                        <FormSection>
                            ...
                            <div className="sm:col-span-full has-tooltip">
                                ...
                                <ToolTipWidget message={trans('user_categories_instruction')}/>
                                <p className={`mt-2  text-gray-500`}>
                            ...
                            <div className="sm:col-span-3 has-tooltip mt-5">
                                ...
                                <div className="mt-1 flex flex-row flex-1 items-center h-32">
                                    ...
                                    />
                                    <img className={`h-24 w-20 bg-cover rounded-md`} src={getThumb(user.image)} alt=""/>
                                </div>
                                <ToolTipWidget message={trans('user_main_image_instruction')}/>
                                ...
                                <div className="mt-1 flex flex-row flex-1 items-center h-32">
                                    ...
                                    />
                                    {
                                        ...
                                        <img className={`h-24 w-20 bg-cover rounded-md`}
                                             src={getThumb(user.images[0]?.image)} alt=""/>
                                    }
                                </div>
                    ...
                    <div
                        ...
                        <FormSection>
                            ...
                            <div className="sm:col-span-3 has-tooltip">
                                ...
                                <ToolTipWidget message={trans('user_description_instruction')}/>
                                <p className={`mt-2  text-gray-500`}>
                            ...
                            {/* service_ar */}
                            <div className="sm:col-span-3 has-tooltip">
                                <label htmlFor="service_ar" className={`block   text-gray-700`}>
                                    {trans('service_ar')}
                                </label>
                                <div className="mt-1">
                                         <textarea
                                ...
                                <ToolTipWidget message={trans('user_notes_instruction')}/>
                                <p className={`mt-2  text-gray-500`}>
                                    {errors.service_ar && <div className={`text-red-900`}>{errors.service_ar}</div>}
                                </p>
                            </div>
                            {/* service en*/}
                            <div className="sm:col-span-3 has-tooltip">
                                <label htmlFor="service_en" className={`block   text-gray-700`}>
                                    {trans('service_en')}
                                </label>
                                <div className="mt-1">
                                         <textarea
                                ...
                                <ToolTipWidget message={trans('user_notes_instruction')}/>
                                <p className={`mt-2  text-gray-500`}>
                                    {errors.service_en && <div className={`text-red-900`}>{errors.service_en}</div>}
                                </p>
                            </div>
                            {/* policy_ar */}
                            <div className="sm:col-span-3 has-tooltip">
                                <label htmlFor="policy_ar" className={`block   text-gray-700`}>
                                    {trans('policy_ar')}
                                </label>
                                <div className="mt-1">
                                         <textarea
                                ...
                                <ToolTipWidget message={trans('user_notes_instruction')}/>
                                <p className={`mt-2  text-gray-500`}>
                                    {errors.policy_ar && <div className={`text-red-900`}>{errors.policy_ar}</div>}
                                </p>
                            </div>
                            {/* policy_en*/}
                            <div className="sm:col-span-3 has-tooltip">
                                <label htmlFor="policy_en" className={`block   text-gray-700`}>
                                    {trans('policy_en')}
                                </label>
                                <div className="mt-1">
                                         <textarea
                            ...
                            <div className="sm:col-span-2 has-tooltip">
                                ...
                                <ToolTipWidget message={trans('user_caption_instruction')}/>
                                <p className={`mt-2  text-gray-500`}>
                            ...
                            <div className="sm:col-span-2 has-tooltip">
                                ...
                                <ToolTipWidget message={trans('fax_instruction')}/>
                                <p className={`mt-2  text-gray-500`}>
                            ...
                            <div className="sm:col-span-2 has-tooltip">
                                ...
                                <ToolTipWidget message={trans('whatsapp_instruction')}/>
                                <p className={`mt-2  text-gray-500`}>
                            ...
                            <div className="sm:col-span-2 has-tooltip">
                                ...
                                <ToolTipWidget message={trans('iphone_instruction')}/>
                                <p className={`mt-2  text-gray-500`}>
                            ...
                            <div className="sm:col-span-2 has-tooltip">
                                ...
                                <ToolTipWidget message={trans('android_instruction')}/>
                                <p className={`mt-2  text-gray-500`}>
                            ...
                            <div className="sm:col-span-2 has-tooltip">
                                ...
                                <ToolTipWidget message={trans('facebook_instruction')}/>
                                <p className={`mt-2  text-gray-500`}>
                            ...
                            <div className="sm:col-span-2 has-tooltip">
                                ...
                                <ToolTipWidget message={trans('twitter_instruction')}/>
                                <p className={`mt-2  text-gray-500`}>
                            ...
                            <div className="sm:col-span-2 has-tooltip">
                                ...
                                <ToolTipWidget message={trans('instagram_instruction')}/>
                                <p className={`mt-2  text-gray-500`}>
                            ...
                            <div className="sm:col-span-2 has-tooltip">
                                ...
                                <ToolTipWidget message={trans('youtube_instruction')}/>
                                <p className={`mt-2  text-gray-500`}>
                            ...
                            <div className="sm:col-span-2 has-tooltip">
                                ...
                                <ToolTipWidget message={trans('website_instruction')}/>
                                <p className={`mt-2  text-gray-500`}>
                                    {errors.website && <div className={`text-red-900`}>{errors.website}</div>}
                                </p>
                            </div>
                            ...
                            <div className="sm:col-span-2">
                                ...
                                <ToolTipWidget message={trans('user_video_url_one_instruction')}/>
                                <p className={`mt-2  text-gray-500`}>
                            ...
                            <div className="sm:col-span-2">
                                ...
                                <ToolTipWidget message={trans('user_video_url_two_instruction')}/>
                                <p className={`mt-2  text-gray-500`}>
                            ...
                            <div className="sm:col-span-2 has-tooltip">
                                ...
                                <ToolTipWidget message={trans('longitude_instruction')}/>
                                <p className={`mt-2  text-gray-500`}>
                            ...
                            <div className="sm:col-span-2 has-tooltip">
                                ...
                                <ToolTipWidget message={trans('latitude_instruction')}/>
                                <p className={`mt-2  text-gray-500`}>
                            ...
                            <div className="sm:col-span-2 has-tooltip">
                                ...
                                <ToolTipWidget message={trans('merchant_id_instruction')}/>
                                <p className={`mt-2  text-gray-500`}>
                                    {errors.merchant_id && <div className={`text-red-900`}>{errors.merchant_id}</div>}
                                </p>
                            </div>
                            ...
                            <div className="sm:col-span-3">
                                ...
                                <ToolTipWidget message={trans('user_qr_instruction')}/>
                                <p className={` text-red-500 rtl:text-left ltr:text-right`}>
