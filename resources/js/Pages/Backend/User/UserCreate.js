                        ...
                        <FormSection title={`${trans('edit')} ${trans(parentModule)}`}>
                            ...
                            {/* end_subscription_date */}
                            {
                                isAdminOrAbove && <div className="sm:col-span-2 has-tooltip mb-5">
                                    ...
                                    <p className={`mt-2  text-gray-500`}>
                                    <span
                                        className={`text-extrabold  text-black`}>{trans('current_date')} : {moment(data.end_subscription_date).format('DD/MM/Y  -|- hh:mm a')}</span>
                                ...
                                <div className="mt-1 flex flex-row flex-1 items-center h-32">
                                    ...
                                    />
                                    {
                                        ...
                                        <img className={`h-24 w-20 bg-cover rounded-md`}
                                             src={getThumb(data.images[0]?.image)} alt=""/>
                                    }
                                </div>
                            ...
                            <div className="sm:col-span-3 hidden">
                                ...
                                <div className="mt-1 flex flex-row flex-1 items-center h-32">
                                    ...
                                    {data.file && <a
                                        ...
                                        target="_blank" href={getFileUrl(data.file)}>{trans('file_url')}</a>}
                                </div>
