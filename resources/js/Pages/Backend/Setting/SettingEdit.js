                ...
                >
                    <div
                        ...
                        <FormSection title={`${trans('edit')} ${trans('settings')}`}>
                            ...
                            <div className="sm:col-span-3">
                                <label htmlFor="name_ar" className={`block text-sm font-medium text-gray-800`}>
                                    {trans('name_ar')}
                                </label>
                                <div className="mt-1">
                                    <input
                            ...
                            {/* name_en */}
                            <div className="sm:col-span-3">
                                <label htmlFor="name_en" className={`block text-sm font-medium text-gray-800`}>
                                    {trans('name_en')}
                                </label>
                                <div className="mt-1">
                                    <input
                            ...
                            <div className="sm:col-span-2 has-tooltip">
                                <label htmlFor="whatsapp" className={`block text-sm font-medium text-gray-800`}>
                                    {trans('whatsapp')}
                                </label>
                                <div className="mt-1">
                                    <input
                            ...
                            <div className="sm:col-span-2 has-tooltip">
                                <label htmlFor="shipment_fixed_rate"
                                ...
                                <p className={`mt-2 text-xs text-gray-500`}>
                                    ...
                                    <div className={`text-red-900`}>{errors.shipment_fixed_rate}</div>}
                                </p>
                            </div>
                            ...
                            {/* payment_methods */}
                            {
                                ...
                                <>
                                    ...
                                    {/* main_theme_color */}
                                    <div className="sm:col-span-2">
                                        <label htmlFor="main_theme_colors"
                                               className="block text-sm font-medium text-gray-800">
                                        ...
                                        <p className={`mt-2 text-xs text-gray-500`}>
                                            ...
                                            <div className={`text-red-900`}>{errors.main_theme_color}</div>}
                                        </p>
                                    </div>
                                    {/* main_theme_bg_color */}
                                    <div className="sm:col-span-2">
                                        <label htmlFor="main_theme_bg_colors"
                                               className="block text-sm font-medium text-gray-800">
                                        ...
                                        <p className={`mt-2 text-xs text-gray-500`}>
                                            ...
                                            <div className={`text-red-900`}>{errors.main_theme_bg_color}</div>}
                                        </p>
                                    </div>
                                    ...
                                    {/* header_theme_color */}
                                    <div className="sm:col-span-2">
                                        <label htmlFor="header_theme_colors"
                                               className="block text-sm font-medium text-gray-800">
                                        ...
                                        <p className={`mt-2 text-xs text-gray-500`}>
                                            ...
                                            <div className={`text-red-900`}>{errors.header_theme_color}</div>}
                                        </p>
                                    </div>
                                    {/* header_theme_bg */}
                                    <div className="sm:col-span-2">
                                        <label htmlFor="header_theme_bgs"
                                               className="block text-sm font-medium text-gray-800">
                                        ...
                                        <p className={`mt-2 text-xs text-gray-500`}>
                                            ...
                                            <div className={`text-red-900`}>{errors.header_theme_bg}</div>}
                                        </p>
                                    </div>
                                    ...
                                    {/* footer_theme_color */}
                                    <div className="sm:col-span-2">
                                        <label htmlFor="footer_theme_colors"
                                               className="block text-sm font-medium text-gray-800">
                                        ...
                                        <p className={`mt-2 text-xs text-gray-500`}>
                                            ...
                                            <div className={`text-red-900`}>{errors.footer_theme_color}</div>}
                                        </p>
                                    </div>
                                    {/* footer_bg_theme_color */}
                                    <div className="sm:col-span-2">
                                        <label htmlFor="footer_bg_theme_colors"
                                               className="block text-sm font-medium text-gray-800">
                                        ...
                                        <p className={`mt-2 text-xs text-gray-500`}>
                                            ...
                                            <div className={`text-red-900`}>{errors.footer_bg_theme_color}</div>}
                                        </p>
                                    </div>
                                    {/* btn_bg_theme_color */}
                                    {/* note that i used this element only for html Background (name is different) */}
                                    <div className="sm:col-span-2">
                                        <label htmlFor="btn_bg_theme_colors"
                                               className="block text-sm font-medium text-gray-800">
                                        ...
                                        <p className={`mt-2 text-xs text-gray-500`}>
                                            ...
                                            <div className={`text-red-900`}>{errors.btn_bg_theme_color}</div>}
                                        </p>
                                    </div>
                                </>
                            }
                                ...
                                <div className="mt-1 flex flex-row flex-1 items-center">
                                    ...
                                    />
                                    {
                                        ...
                                        <img className={`h-24 w-20 bg-cover rounded-md`}
                                             src={getThumb(setting.images[0]?.image)} alt=""/>
                                    }
                                </div>
                                    ...
                                    <div className="mt-4 space-y-4">
                                        <div className="flex items-center">
                                            <input
                                                ...
                                                type="radio"
                                                value={1}
                                                defaultChecked={setting.enable_receive_from_shop}
                                                className={`mx-5 focus:ring-gray-500 h-4 w-4 text-gray-600 border-gray-300`}
                                            />
                    ...
                    <div
                        ...
                        <FormSection title={trans('more_details')}>
                            ...
                            {/* shipment notes_ar */}
                            <div className="sm:col-span-3 has-tooltip">
                                <label htmlFor="notes_ar" className={`block text-sm font-medium text-gray-800`}>
                        ...
                        <FormSection title={trans('more_details')}>
                            ...
                            {/* instagram */}
                            <div className="sm:col-span-2">
                                <label htmlFor="instagram" className={`block text-sm font-medium text-gray-800`}>
                                    {trans('instagram')}
                                </label>
                                <div className="mt-1">
                                    <input
                            ...
                            {/* facebook */}
                            <div className="sm:col-span-2">
                                <label htmlFor="facebook" className={`block text-sm font-medium text-gray-800`}>
                                    {trans('facebook')}
                                </label>
                                <div className="mt-1">
                                    <input
                            ...
                            {/* twitter */}
                            <div className="sm:col-span-2">
                                <label htmlFor="twitter" className={`block text-sm font-medium text-gray-800`}>
                                    {trans('twitter')}
                                </label>
                                <div className="mt-1">
                                    <input
                            ...
                            {/* snapchat */}
                            <div className="sm:col-span-2">
                                <label htmlFor="snapchat" className={`block text-sm font-medium text-gray-800`}>
                                    {trans('snapchat')}
                                </label>
                                <div className="mt-1">
                                    <input
                            ...
                            {/* youtube */}
                            <div className="sm:col-span-2">
                                <label htmlFor="youtube" className={`block text-sm font-medium text-gray-800`}>
                                    {trans('youtube')}
                                </label>
                                <div className="mt-1">
                                    <input
                            ...
                            {/* android */}
                            <div className="sm:col-span-2">
                                <label htmlFor="android" className={`block text-sm font-medium text-gray-800`}>
                                    {trans('android')}
                                </label>
                                <div className="mt-1">
                                    <input
                            ...
                            {/* apple */}
                            <div className="sm:col-span-2">
                                <label htmlFor="apple" className={`block text-sm font-medium text-gray-800`}>
                                    {trans('apple')}
                                </label>
                                <div className="mt-1">
                                    <input
                            ...
                            {/* country_ar */}
                            <div className="sm:col-span-2">
                                <label htmlFor="country_ar" className={`block text-sm font-medium text-gray-800`}>
                                    {trans('country_ar')}
                                </label>
                                <div className="mt-1">
                                    <input
                            ...
                            {/* country_en */}
                            <div className="sm:col-span-2">
                                <label htmlFor="country_en" className={`block text-sm font-medium text-gray-800`}>
                                    {trans('country_en')}
                                </label>
                                <div className="mt-1">
                                    <input
