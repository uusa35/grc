                ...
                >
                    <FormSection title={`${trans('edit')} ${trans('country')}`}>
                        ...
                        <div className="sm:col-span-2">
                            ...
                            <p className={`mt-2  text-gray-500`}>
                                {errors.calling_code && <div className={`text-red-600`}>{errors.calling_code}</div>}
                            </p>
                        </div>
                        ...
                        <div className="sm:col-span-2">
                            ...
                            <p className={`mt-2  text-gray-500`}>
                                {errors.country_code && <div className={`text-red-600`}>{errors.country_code}</div>}
                            </p>
                        </div>
                        ...
                        <div className="sm:col-span-2">
                            ...
                            <p className={`mt-2  text-gray-500`}>
                                {errors.fixed_shipment_charge && <div className={`text-red-600`}>{errors.fixed_shipment_charge}</div>}
                            </p>
                        </div>
