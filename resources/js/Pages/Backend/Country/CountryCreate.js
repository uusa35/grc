...
export default function() {
    ...
    const submit = (e) => {
        e.preventDefault()
        Inertia.post(route(`backend.country.store`), {
            ...data,
            image: data.image,
        }, {
            forceFormData: true,
                ...
                >
                    <FormSection title={`${trans('edit')} ${trans('country')}`}>
                        ...
                        <div className="sm:col-span-2">
                            ...
                            <ToolTipWidget message={trans('calling_code_instruction')}/>
                            <p className={`mt-2  text-gray-500`}>
                                {errors.calling_code && <div className={`text-red-900`}>{errors.calling_code}</div>}
                            </p>
                        </div>
                        ...
                        <div className="sm:col-span-2">
                            ...
                            <ToolTipWidget message={trans('country_code_instruction')}/>
                            <p className={`mt-2  text-gray-500`}>
                                {errors.country_code && <div className={`text-red-900`}>{errors.country_code}</div>}
                            </p>
                        </div>
                        ...
                        <div className="sm:col-span-2">
                            ...
                            <ToolTipWidget message={trans('fixed_shipment_charge_instruction')}/>
                            <p className={`mt-2  text-gray-500`}>
                                {errors.fixed_shipment_charge && <div className={`text-red-900`}>{errors.fixed_shipment_charge}</div>}
                            </p>
                        </div>
...
accept="image/jpg, image/jpeg , image/png"
                                ...
                                />
                                <img className={`h-24 w-20 bg-cover rounded-md`} src={getThumb(data.image)} alt=""/>
                            </div>
                    ...
                    <FormSection title={trans('more_details')}>
                        ...
                        <fieldset className="mt-1 col-span-1">
                            <div>
                                <legend
                                    className={`text-base  text-gray-900`}>{trans('has_currency')}</legend>
                            </div>
                            <div className="mt-4 space-y-4">
                                <div className="flex items-center">
                                    <input
                            ...
                            <div>
                                <p className={`mt-2  text-gray-500`}>
                                    {errors.has_currency && <div className={`text-red-900`}>{errors.has_currency}</div>}
                                </p>
                            </div>
                        </fieldset>
                    </FormSection>
