            ...
            <div className="flex flex-col bg-white shadow-md rounded-md">
                <form
                    ...
                    <div className="space-y-4 divide-y 900">
                        <div className={`pt-4`}>
                            <h3 className="text-lg leading-6 font-medium text-gray-900">{trans('create')} {trans('timing')}</h3>
                            ...
                            <div className="sm:col-span-2 has-tooltip mb-5">
                                ...
                                <div className="mt-1">
                                    <input
                                        ...
                                        type="date"
                                        min={moment().add(1,'days').format('Y-MM-DD')}
                                        max={moment().add(30, 'days').format('Y-MM-DD')}
                                        // type="datetime-local"
                                        step="any"
                                        name="date"
                                        id="date"
