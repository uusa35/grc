...
export default function({privilege, pivotElements}) {
    ...
    const submit = (e) => {
        e.preventDefault()
        Inertia.post(route(`backend.privilege.update`, privilege.id), {
            _method: 'put',
            ...data,
            image: data.image,
        }, {
            ...
            <div className="flex flex-col bg-white shadow-md rounded-md">
                <form
                    ...
                    <div className="space-y-4 divide-y 900">
                        ...
                        <div className="pt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                            ...
                            <div className="sm:col-span-full has-tooltip mt-5">
                                ...
                                <div className="mt-1 flex flex-row flex-1 items-center h-32">
                                    ...
                                    />
                                    {privilege.image && <img className={`h-24 w-20 bg-cover rounded-md`}
                        ...
                        <div className={`pt-4`}>
                            <h3 className="text-lg leading-6 font-medium text-gray-900">{trans('attributes')} {trans('privilege')} {pluralize(trans(privilege[getLocalized()]))}</h3>
                            <p className="mt-1 text-sm text-gray-500">
                                {trans('attributes')}
                            </p>
                        </div>
                        <div className="pt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-4">
                            ...
                            <fieldset className="mt-1 col-span-1">
                                <div>
                                    <legend
                                        className={`text-base  text-gray-900`}>{trans('main_menu')}</legend>
                                </div>
