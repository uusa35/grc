...
export default function ProductIndex({elements, settings})  {
    const {
        trans,
        classNames,
        isRTL,
                                            ...
                                            <tr className={'bg-white border-b border-gray-100'} key={element.id}>
                                                ...
                                                <td className="px-3 py-4 whitespace-nowrap text-sm text-gray-500">
                                                    ...
                                                    <div className="flex flex-1 flex-row justify-between space-x-3 mt-2 items-center">
                                                        <span className={`inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-${ element.has_attributes && !isEmpty(element.product_attributes) ? 'green' : 'red'}-100 text-${theme}-800`}>
                                                                                ...
                                                                                <Menu.Item>
                                                                                    {({active}) => (
                                                                                        <button
                                                                                            ...
                                                                                            className={classNames(
                                                                                                active ? 'bg-gray-100 text-gray-900' : 'text-gray-700',
                                                                                                'flex flex-1 w-full flex-row items-center block px-4 py-2 text-sm ltr:text-left rtl:text-right text-red-700'
                                                                                            )}
                                                                                        >
                                                                                            <svg
                                                                                                xmlns="http://www.w3.org/2000/svg"
