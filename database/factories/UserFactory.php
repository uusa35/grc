...
class UserFactory extends Factory
{
    ...
    public function definition()
    {
        ...
        return [
            ...
            'mobile' => $this->faker->randomNumber(111111,999999),
            'phone' => $this->faker->randomNumber(111111,999999),
            'fax' => $this->faker->randomNumber(111111,999999),
            'image' => 'square.png',
            'qr' => 'sample.png',
            'banner' => 'sample.png',
            'bg' => 'sample.png',
            ...
            'whatsapp' => $this->faker->randomNumber(111111,999999),
