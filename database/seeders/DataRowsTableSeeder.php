...
class DataRowsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $userDataType = DataType::where('name', 'users')->firstOrFail();
        $menuDataType = DataType::where('name', 'menus')->firstOrFail();
        $roleDataType = DataType::where('name', 'roles')->firstOrFail();
