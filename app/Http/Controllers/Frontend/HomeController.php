...
class HomeController extends Controller
{
    public function index()
    {
        ...
        $categoriesWithProducts = CategoryExtraLightResource::collection(Category::active()->onlyParent()->onlyForProducts()->orderBy('order','asc')->limit(3)->with('products.user')->get());
