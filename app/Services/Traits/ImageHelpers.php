            ...
            foreach ($sizes as $key => $value) {
                if ($value === 'large') {
                    if ($ratio) {
                        ...
                        $large->insert($img->resize(($dimensions[0] - ($dimensions[0] /6)), null, function ($constraint) {
                            $constraint->aspectRatio();
                        }), 'center');
                    ...
                    if ($ratio) {
                        ...
                        $medium->insert($img->resize(($dimensions[0] - ($dimensions[0] /6)) / 2, null, function ($constraint) {
                            $constraint->aspectRatio();
                        }), 'center');
                    ...
                    if ($ratio) {
                        ...
                        $thumbnail->insert($img->resize(($dimensions[0] - ($dimensions[0] /6)) / 3, null, function ($constraint) {
                            $constraint->aspectRatio();
                        }), 'center');
